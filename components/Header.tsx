      ...
      shadow-[0_8px_30px_rgba(0,0,0,0.06)]">
        ...
        <div className="max-w-[1400px] mx-auto px-4 lg:px-6 relative">
          ...
          <div className="flex items-center justify-between h-[72px] lg:h-[95px]">
            ...
            {/* LEFT */}
            <div className="flex items-center gap-3 w-[120px] lg:w-auto">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                <span className="absolute -top-1 -right-1 text-[8px] bg-white text-[#CC0000] px-[5px] py-[1px] rounded-full border border-[#CC0000] font-semibold">
                  2
                </span>
              </div>
          ...
          <Link
            href="/"
            className="absolute left-1/2 top-[50%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center"
          >
            <img src="/logo1.png" className="h-[36px] lg:h-[50px]" />

            <span className="text-[12px] lg:text-[18px] tracking-[0.4em] font-semibold uppercase">
              Tirumala
            </span>

            <span className="text-[8px] tracking-[0.5em] text-[#CC0000] uppercase">
              Family Mall
            </span>
          </Link>
      ...
      <>
        ...
        >
          ...
          <nav className="flex flex-col gap-6 text-[15px] font-medium">
            ...
            <Link href="/collections/women" onClick={() => setMenuOpen(false)}>
              Women
            </Link>
            ...
            <Link href="/collections/kids" onClick={() => setMenuOpen(false)}>
              Kids
            </Link>
